            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="{{ url('/admin/users')}}"><i class="fa fa-user fa-3x"></i>Users</a>
                    </li>
                </ul>      
            </div>
        </nav>  
                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="{{ asset('assets/admin/img/1.png') }}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src="{{ asset('assets/admin/img/2.png') }}" alt="User" class="img-circle" />
                                    </span>
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src="{{ asset('assets/admin/img/3.png') }}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src="{{ asset('assets/admin/img/4.png') }}" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
